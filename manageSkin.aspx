<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manageSkin.aspx.cs" Inherits="naturefriends.manageSkin" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Manage Skin Stock</title>
...
<body>
    <form id="form1" runat="server">
        <div class="container mt-4">
            ...
            <h2>Manage Skin Stock</h2>
            <asp:Label ID="lblMessage" runat="server" CssClass="mb-3" />

            <asp:GridView ID="gridSkinStock" runat="server" AutoGenerateColumns="False" CssClass="table table-striped"
                DataKeyNames="productid" OnRowCommand="gridSkinStock_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Update Skin Stock" ItemStyle-Width="30%">
                        <ItemTemplate>
